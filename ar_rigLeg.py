...
def ar_rigLegs(LegStart='RightUpLeg_CJ',Heel='RightHeel_CJ',HeelExt='RightHeelExt_CJ',HeelInt='RightHeelInt_CJ',Side='Right',bendOnOff=1,bendJnts=3,chrScale=1,method=0):
	jntCount=5
